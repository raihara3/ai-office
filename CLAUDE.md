...
- Task queue: the kanban board (`board.js`; rows in the `cards` table, each
  ...
  a done column sorted newest first by `doneAt`; unfinished execution order
  ...
  run marks the card done (it moves to the done column and stays there until the human
