...
erDiagram
    ...
    residents {
        ...
        TEXT    role              "NOT NULL DEFAULT 'board'; CHECK: board / scheduled"
        ...
        TEXT    trigger           "NOT NULL; JSON text, validated before write; quoted (SQL keyword). Used only by scheduled residents"
        TEXT    precheck          "nullable shell command; gates scheduled runs only"
