...
const dictionaries = {
  en: {
    ...
    'appbar.task': 'Task',
    'appbar.usage': 'Payroll',
    'appbar.usageTitle': 'Token usage per resident',
    'usage.title': 'Payroll',
    'usage.caption': 'Token usage per resident (input / output). Cached prompt tokens count as input.',
    'usage.resident': 'Resident',
    'usage.recent': 'Last 30 days',
    'usage.total': 'Total',
    'usage.runs': 'Runs',
    'usage.empty': 'No residents yet',
  ...
  ja: {
    ...
    'appbar.task': 'タスク',
    'appbar.usage': '人件費',
    'appbar.usageTitle': '常駐メンバーごとのトークン使用量',
    'usage.title': '人件費',
    'usage.caption': '常駐メンバーごとのトークン使用量(入力 / 出力)。キャッシュされたプロンプトも入力に数えます。',
    'usage.resident': 'メンバー',
    'usage.recent': '直近30日',
    'usage.total': '累計',
    'usage.runs': '実行回数',
    'usage.empty': '常駐メンバーがいません',
    'usage.loadFailed': '使用量を取得できませんでした。',
    'zoom.label': 'ズーム',
    'zoom.out': '縮小',
    'zoom.fit': '全体表示に戻す',
    'zoom.in': '拡大',
