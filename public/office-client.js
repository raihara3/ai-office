// Transport layer for the office UI: wraps the SSE state stream and the
// resident/team/board HTTP calls so the rendering/audio code stays independent
// of *how* data arrives. Swapping SSE for Electron IPC later means changing
// only this file, not the UI. Exposed as window.OFFICE_CLIENT, matching
// window.OFFICE.
